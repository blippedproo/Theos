...
double batLeft = (float)[myDevice batteryLevel] * 100;
    ...
    self.displayLabel.font = [UIFont fontWithName:@"AvenirNext-HeavyItalic" size:10];


NSString *WMText = [NSString stringWithFormat:@"HHNiOS-hhnios.site •%@  Pin: %0.0f (%d FPS)",mustr,batLeft,(int)round(fps)]; 
